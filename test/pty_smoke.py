...
try:
 pump(.4)
 for key in [b'w',b'3',b'4',b'5',b'1',b'/MOON\r',b'/\x15\r',b'd0x0000000000000000000000000000000000000001\r',b'2',b'1',b'\x1b[B',b'6',b'u',b'7',b'e',b'1',b'\r',b'\x1b[B',b'\x1b',b'?',b'\x1b',b'p',b'p',b'q']:
 ...
 print(json.dumps({'exit':p.returncode,'watch_saved':True,'selected_prediction_saved':True,'daily_exported':True,'terminal_restored':True,'lock_released':True}))
finally:
